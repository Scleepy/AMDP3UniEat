<?php
    ...
    include "./includes/usersettingslogic.php";
?>
...
<?php include "./includes/header.php" ?>
    <div class="wide-container">
        <form class="settings-form" action="./usersettings.php" method="POST">
            
            <div class="settings-item">
                <label for="" >Name</label>
                <?php echo "<input class='form-control' name='username' type='text' value='$name'>" ?>
            </div>

            <div class="settings-item">
                <label for="">Phone Number</label>
                <?php echo "<input class='form-control' name='phonenumber' type='text' value='$phoneNumber'>" ?>
            </div>

            <div class="settings-item">
                <label for="">Email</label>
                <?php echo "<input class='form-control' name='email' type='email' value='$email' disabled>" ?>
            </div>
