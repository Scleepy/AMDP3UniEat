<?php
    ...
    $query = "SELECT * FROM shop JOIN shopcategories ON shop.shopID = shopcategories.shopID JOIN categories ON shopcategories.categoryID = categories.categoryID WHERE categoryName LIKE '%drinks%'";
